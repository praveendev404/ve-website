    ...
    >
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <h1 className="display-4 display-md-3 fw-bold mb-3 mb-md-4">The Precision Edge Your Workforce Needs</h1>
              ...
              <div className="d-flex flex-column flex-sm-row gap-3 mb-3 mb-md-4">
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              <h2 className="display-6 fw-bold mb-3 mb-md-4">One Platform. Four Powerful Modules.</h2>
              <p className="lead text-muted mb-3 mb-md-4">
      ...
      <section className="py-4 py-md-5 bg-light">
        <div className="container">
          <div className="row">
            <div className="col-lg-8 mx-auto text-center">
              <h2 className="display-6 fw-bold mb-3 mb-md-4">Ready to Give Your Team the Edge?</h2>
              <p className="lead text-muted mb-3 mb-md-4">
                Join the fastest-growing teams who've replaced manual HR with precision automation.
              </p>
              <button className="btn btn-primary btn-lg px-4 px-md-5">Start Free Trial</button>
